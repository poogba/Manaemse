...
<s:form action="clazz_upload.action" method="post" enctype="multipart/form-data">
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  <tr>
	    <td width="120">课程类别：</td>
	    <td><s:property value="cc.crmCourseType.courseName" /></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>班级：</td>
	    <td><s:property value="cc.name" /></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>上次上传时间：</td>
	    <td><s:property value="cc.uploadTime"/></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>选择课表：</td>
