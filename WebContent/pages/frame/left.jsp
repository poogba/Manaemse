...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010201','0102','在校学生管理','${pageContext.request.contextPath}/stud_findall.action','','right');
		...
		d.add('010301','0103','班级管理','${pageContext.request.contextPath}/clazz_findall.action','','right');
		/* d.add('010302','0103','课程类别','${pageContext.request.contextPath}/pages/coursetype/listCourse.jsp','','right'); */
		d.add('010302','0103','课程类别','${pageContext.request.contextPath}/course_findall.action?isSearch=false','','right');
		d.add('0104','01','就业部');
		...
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/dep_findall.action','','right');
		/* d.add('010502','0105','职务管理','${pageContext.request.contextPath}/pages/post/listPost.jsp','','right'); */
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/post_findall.action','','right');
		/* d.add('010503','0105','员工管理','${pageContext.request.contextPath}/pages/staff/listStaff.jsp','','right'); */
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/staff_findall.action?isSearch=false','','right');
