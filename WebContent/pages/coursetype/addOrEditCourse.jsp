...
<body class="emp_body">
	...
	<table border="0" cellspacing="0" cellpadding="0" class="wukuang"
		...
		<tr>
			...
			<td width="52%" align="right"><a href="javascript:void(0)"
	...
	<s:if test="courseTypeId==null">
		<form action="course_add.action" method="post">
			<table width="88%" border="0" class="emp_table" style="width: 80%;">
				<tr>
					<td width="10%">课程类别：</td>
					<td width="20%"><input type="text" name="courseName" /></td>
					<td width="8%">总学时：</td>
	...
	<s:else>
		<s:form action="course_update.action" method="post">
			<s:hidden name="courseTypeId" />
			<table width="88%" border="0" class="emp_table" style="width: 80%;">
				<tr>
					<td width="10%">课程类别：</td>
					<td width="20%"><s:textfield name="cct.courseName" /></td>
					<td width="8%">总学时：</td>
					<td width="62%"><s:textfield name="cct.total" /></td>
				</tr>
				<tr>
					<td>课程费用：</td>
					<td><s:textfield name="cct.courseCost" /></td>
					<td></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="4"><s:textarea name="cct.remark" cols="60" rows="10" /></td>
				</tr>
			</table>
		</s:form>
	</s:else>
