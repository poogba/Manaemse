...
<s:if test="depId==null">
	<s:form action="dep_add.action" method="post">
		<table width="88%" border="0" class="emp_table" style="width: 80%;">
			<tr>
				<td>部门名称：</td>
				<td><s:textfield name="depName" /></td>
			</tr>
		</table>
	</s:form>
</s:if>
<s:else>
	<s:form action="dep_edit.action" method="post">
		<s:hidden name="cd.depId" />
		<table width="88%" border="0" class="emp_table" style="width: 80%;">
			<tr>
				<td>部门名称：</td>
				<td><s:textfield name="cd.depName" /></td>
			</tr>
		</table>
	</s:form>
</s:else>
